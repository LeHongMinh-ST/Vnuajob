                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-4">
                                            <div class="row">
                                                ...
                                                <input type="text" class="form-control col-10" id="salary" name="salary"  placeholder="Mức lương tối thiểu bằng số (vd: 10.000.000)" onChange="format_curency(this);">
                                        ...
                                        <div class="form-group col-4">
                                            <div class="row">
                                                <label for="salary">Mức lương tối đa</label>
                                                <input type="text" class="form-control col-10" id="salary" name="salary"  placeholder="Mức lương tối đa bằng số (vd: 10.000.000)" onChange="format_curency(this);">
                                                <span class="col-2" style="padding-top: 10px;">VNĐ</span>
                                            </div>
                                        </div><!-- /.form-group -->
                                    </div>
