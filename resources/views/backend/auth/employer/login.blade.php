...
<html lang="en">
  <head>
    ...
    <!-- Begin SEO tag -->
    <title> Đăng nhập | Admin Vnua Job </title>
  ...
  <body>
    ...
    <main class="auth auth-floated">
      <!-- form -->
      <form class="auth-form" action="{{ route('employers.loginProcess') }}" method="post">
        @csrf
        <div class="mb-4">
          <div class="mb-3">
        ...
        <!-- copyright -->
        <p class="mb-0 px-3 text-muted text-center"> © 2018 Vũ Thị Uyên.
        </p>
      </form><!-- /.auth-form -->
      <!-- .auth-announcement -->
